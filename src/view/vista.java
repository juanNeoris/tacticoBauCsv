...
public class vista extends JFrame {
	...
	public vista() {
		...
		f.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\juan.baca\\OneDrive - NEORIS\\Proyectos\\LibreriasJava\\santecLogo.png"));
		f.setSize(357, 338);
	...
	public void validaFicherosDolphinVictoria() {
		...
		File filDolphin = new File("\\\\mx2ct1hnascifnfsevs1.mx.corp\\ExtraccionesMIR\\rtra\\PRO\\"+"rtra-cream-ges-dolphin-europa_mexico_"+fechaCal+".txt");
		File filVictoria =new File("\\\\mx2ct1hnascifnfsevs1.mx.corp\\ExtraccionesMIR\\rtra\\PRO\\"+"rtra-cream-ges-victoria-europa_mexico_"+fechaCal+".txt");
	...
	public void cargaVictoriaDolphing() {
		...
		try {
			/*establecemos las variables de conexion para tranferir los RTRA
			 * una vez que validemos que existen en la ruta 
			 * */
			...
			/*establecemos las variables de conexion 
			 * se valida que existan las interfaces en la ruta: /planPGTMEX/procesos/RISK/interfaces
			 * */
			SSHConnector sshConnector = new SSHConnector();
			sshConnector.connect(username, PASSWORD, host, 22);
			...
			/*Se validan los logs si el proceso termino de manera
			 * exitosa
			 * */
			...
			String resultLogsVictoria = sshConnector.executeCommand("cd /planPGTMEX/procesos/RISK/salidas/"+dateShelRTRALog+"/cargartrabau.sh; ls -ltr interfazVictoria.bad");
