...
public class Instrumento {
	 ...
	 */
	private static String cadenaEncabezado = "CPTYPARENT|CPTYPARENTRATING|CPTYPARENTNAME|DEALSTAMP|INSTRUMENTNAME|VALUEDATE|MATURITYDATE|CURRENCY|NOMINALVALUECUR|CER|NOMINALVALUE|ONEOFF|CPTYNAME|FOLDERCOUNTRYNAME|CPTYCOUNTRY|CPTYPARENTCOUNTRY|FOLDERCOUNTRY|CPTY|LASTPARENT|LASTPARENTNAME|LASTPARENTCOUNTRY|LASTPARENTRATING|FOLDERNAME|GUARANTEEPERCENTCPTY|ADDONCUR|GUARANTEEDPARENTRATING|REQUIVALENTE|RECBRUTO|LASTPARENTF|LASTPARENTFNAME|LASTPARENTFCOUNTRYNAME|LASTPARENTFRATING|DISPUESTO|CER2|COLLATERALAGREEMENT\n";
